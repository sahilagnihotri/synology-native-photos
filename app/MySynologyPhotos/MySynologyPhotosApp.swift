...
/// What `MySynologyPhotosApp` ends up showing: either the composed
...
@main
struct MySynologyPhotosApp: App {
    /// Scene id for the custom About window, opened from the app menu's
    /// "About MySynology Photos" item (see the `.commands` block below).
    ...
    var body: some Scene {
        ...
        .commands {
            // Replace the stock "About MySynologyPhotos" item so it opens our
        ...
        Window("About MySynology Photos", id: Self.aboutWindowID) {
            AboutView()
        }
...
/// The app menu's "About MySynology Photos" item. A tiny view rather than an
...
private struct AboutMenuButton: View {
    ...
    var body: some View {
        Button("About MySynology Photos") {
            openWindow(id: MySynologyPhotosApp.aboutWindowID)
        }
    }
}
