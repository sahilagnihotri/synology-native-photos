...
enum LoginPreferencesStore {
    private static let hostKey = "se.agnihotri.mysynologyphotos.login.host"
    private static let usernameKey = "se.agnihotri.mysynologyphotos.login.username"
    private static let rememberMeKey = "se.agnihotri.mysynologyphotos.login.rememberMe"
    private static let allowUntrustedTlsKey = "se.agnihotri.mysynologyphotos.login.allowUntrustedTls"
